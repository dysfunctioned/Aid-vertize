...
export default function WidgetsBarInactive(props) {
    ...
    return (
        <Slide direction="right" in={!props.widgetsDisplay} timeout={200}>
            <div
                style={{
                    display: 'flex',
                    ...
                    left: '13px',
                    position: 'absolute',
                    background: containerHover ? 'white' : 'rgba(217, 217, 217, 0.40)',
            ...
            >
                <ButtonGroup orientation='vertical' sx={{ flex: 1 }}>
                    ...
                    <div style={{ width: '29px', borderTop: '1px solid #BABCBE', marginLeft: '5px', }} />
